    ...
    public boolean ftpConnect(String host, String username, String password,
        ...
        try {
            ...
            if (FTPReply.isPositiveCompletion(mFTPClient.getReplyCode())) {
                ...
                System.out.println("status connect : " + status);
                return status;
            }
        } catch (Exception e) {
        ...
        try {
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (isFile) {
                    fileList[i] = "File :: " + name;
                    Log.i(TAG, "File : " + name);
                    System.out.println("source : " + MyVars.FOLDER_DATA + name);
                    System.out.println("target : " + Environment.getExternalStorageDirectory()
